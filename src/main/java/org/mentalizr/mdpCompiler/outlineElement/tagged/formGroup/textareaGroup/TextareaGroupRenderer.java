...
public class TextareaGroupRenderer extends OutlineElementRenderer {
    ...
    public void render(OutlineElementModel outlineElementModel, CompilerContext compilerContext, Result result) throws MDPSyntaxError {
        ...
        TextareaGroupAttributes textareaGroupAttributes = (TextareaGroupAttributes) textBlockModel.getOutlineElementTaggedAttributes();
        ...
        FormGroupRendererHelper.renderHeaderLines(textBlockModel, textareaGroupAttributes.getId(), result, compilerContext);
