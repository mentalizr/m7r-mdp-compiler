...
public class ImgTextRenderer extends OutlineElementRenderer {
    ...
    public ImgTextRenderer(Result result, ImgTextAttributes imgTextAttributes, TextBlockModel textBlockModel, String mdpTagLink) {
        super(result);
    ...
    public void render(CompilerContext compilerContext) throws MDPSyntaxError {
        ...
        this.result.addLn(indent,"<div class=\"row\" "
        ...
        this.result.addLn(indent + 1,"<div class=\"col-xs-12 col-sm-" + imgColWidth
                + " col-md-" + imgColWidth
                + " col-lg-" + imgColWidth
                + "\">");
        ...
        this.result.addLn(indent + 2, imgTag);

        this.result.addLn(indent + 1, "</div>");
        this.result.addLn(indent + 1, "<div class=\"col-xs-12 col-sm-" + textColWidth + " col-md-" + textColWidth + " col-lg-" + textColWidth + "\">");
